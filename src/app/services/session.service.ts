 ...
 * @returns {Promise<Session | null>} - Session object or null
 */
async function updateOneSessionById(
	id: string | mongoose.Types.ObjectId,
 ...
 */
async function updateOneSession(
	filter: FilterQuery<Session>,
	data: UpdateQuery<Session>,
): Promise<any> {
 ...
 * @returns {Promise<Session | null>} - Session object or null
 */
async function deleteOneSessionById(
	id: string | mongoose.Types.ObjectId,
): Promise<Session | null> {
...
async function revokeSession(
	...
	const user = await UserService.getOneUserById(
		session.userId as mongoose.Types.ObjectId,
	);
